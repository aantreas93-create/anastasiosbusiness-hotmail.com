...
class AddressHotelPage extends StatefulWidget {
  const AddressHotelPage({
    super.key,
    required this.lat,
    required this.lng,
  ...
  @override
  State<AddressHotelPage> createState() => _AddressHotelPageState();
}

class _AddressHotelPageState extends State<AddressHotelPage> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _field("Hotel name", "e.g. Radisson Blu", hotelCtrl),
          _field("Room number", "e.g. 512", roomCtrl),
          _field("Notes", "Additional instructions", notesCtrl, maxLines: 3),
