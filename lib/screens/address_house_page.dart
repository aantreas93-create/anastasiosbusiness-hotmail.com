...
class AddressHousePage extends StatefulWidget {
  const AddressHousePage({
    super.key,
    required this.lat,
    required this.lng,
  ...
  @override
  State<AddressHousePage> createState() => _AddressHousePageState();
}

class _AddressHousePageState extends State<AddressHousePage> {
  static const ink = Color(0xFF1A233D);
  static const inkLight = Color(0xFF2A3A58);

  final entranceCtrl = TextEditingController();
  final nameOnDoorCtrl = TextEditingController();
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _field("Name / Number on door", "e.g. 5 or surname", nameOnDoorCtrl),
        ...
        onPressed: () {
          final data = {
            ...
            "details": {
              ...
              "nameOnDoor": nameOnDoorCtrl.text.trim(),
            },
            "lat": widget.lat,
            "lng": widget.lng,
